...
;
; Description:
;		This is the edge-triggered polling server. It creates a new process for each
;		incoming connection.
;
; ----------------------------------------------------------------------------
...
;FUNCTION
;
;Name:			epoll server edge triggered
;
;Prototype:		void epoll_server_et(eax dword port, ebx dword process_count)
;
;Developer:		Jordan Marling
;
;Created On: 	2015-02-09
...
;FUNCTION
;
;Name:			Add Epoll Descriptor edge-triggered
;
...
epoll_server_add_descriptor:
	...
	mov dword [ epoll_event + ee_events ], EPOLLIN | EPOLLERR | EPOLLHUP | EPOLLET	; flags
